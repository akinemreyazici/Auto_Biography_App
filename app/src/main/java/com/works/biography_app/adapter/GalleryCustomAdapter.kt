...
class GalleryCustomAdapter(private val context: Activity, private val list: List<Gallery>) : ArrayAdapter<Gallery>(context,R.layout.custom_gallery_layout,list)
{
